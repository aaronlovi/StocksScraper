    ...
    private async Task SeedScores() {
        var scores = new List<CompanyScoreSummary> {
            new(1, "320193", "Apple Inc", "AAPL", "NASDAQ", 11, 13, 5,
                ...
                200_000_000m, 100_000_000m, 90_000_000m, 15.0m, 14.0m, 8.5m, 7.2m,
            ...
            new(2, "789019", "Microsoft Corporation", "MSFT", "NASDAQ", 9, 13, 5,
                ...
                180_000_000m, 90_000_000m, 85_000_000m, 12.0m, 11.0m, 7.0m, 6.5m,
            ...
            new(3, "1018724", "Amazon.com Inc", "AMZN", "NASDAQ", 7, 13, 5,
                ...
                150_000_000m, 80_000_000m, 75_000_000m, 8.0m, 7.0m, 6.0m, 5.5m,
                190m, new DateOnly(2024, 12, 19), 90_000_000, null, null, null, null, Now),
            new(4, "1326801", "Meta Platforms Inc", "META", "NASDAQ", 10, 13, 5,
                350_000_000m, 1_200_000_000_000m, 0.2m, 3.5m, 0.3m,
                160_000_000m, 95_000_000m, 88_000_000m, 20.0m, 18.0m, 9.0m, 8.0m,
                550m, new DateOnly(2024, 12, 19), 50_000_000, null, null, null, null, Now),
            new(5, "34088", "Exxon Mobil Corporation", "XOM", "NYSE", 12, 13, 5,
                600_000_000m, 500_000_000_000m, 0.1m, 2.0m, 0.2m,
                250_000_000m, 120_000_000m, 110_000_000m, 18.0m, 16.0m, 12.0m, 11.0m,
                110m, new DateOnly(2024, 12, 19), 200_000_000, null, null, null, null, Now),
        };
