...
internal sealed class GetLatestPriceByTickerStmt : QueryDbStmtBase {
...
";
    ...
    public GetLatestPriceByTickerStmt(string ticker)
        : base(Sql, nameof(GetLatestPriceByTickerStmt)) {
        _ticker = ticker;
    }
